		...
		<section class="container">
			<div class="form-group custom-input-space has-feedback">
				<div class="page-heading">
					<h3 class="post-title">REGISTERED COMPANY DATA</h3>
				</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<a class="btn btn-warning" href="cexport_excel.php" target="_new" ><i class="fa fa-download"></i> Export to Excel</a>
									...
									<table width="100%" border="1">
										...
										//get rows query
										$query = mysqli_query($con, "SELECT * FROM company ORDER BY sno DESC");
										...
										<tr>
											...
											<td><?php echo ucfirst($row["loc"]); ?></td>
											<td><?php echo ucfirst($row["vdate"]); ?></td>
											<td><?php echo ucfirst($row["pack"]); ?></td>
											<td><?php echo ucfirst($row["pno"]); ?></td>
