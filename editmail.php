...
$myfile = fopen("subject.txt", "w") or die("Unable to open file!");
fwrite($myfile, $sub);
fclose($myfile);
$myfile1 = fopen("message.txt", "w") or die("Unable to open file!");
fwrite($myfile1, $msg);
fclose($myfile1);
?>
...
<center> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mail.php" class="btn btn-primary"><button>Mailing</button></a></center>
</div>
</div>
