						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<a class="btn btn-warning" href="export_excel2.php" target="_new" ><i class="fa fa-download"></i> Export to Excel</a>
									...
									<table width="100%" border="1">
										...
										//get rows query
										$query = mysqli_query($con, "SELECT * FROM reg2 ORDER BY sno DESC");
										...
										<tr>
											...
											<td><?php echo ucfirst($row["project"]); ?></td>
											<td><?php echo ucfirst($row["syno"]); ?></td>
											<td><?php echo ucfirst($row["gname"]); ?></td>
											<td><?php echo ucfirst($row["name1"]); ?></td>
										</tr>
										<?php $sno++;
											}
										} ?>
