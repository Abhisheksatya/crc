						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<a class="btn btn-warning" href="export_excel3.php" target="_new" ><i class="fa fa-download"></i> Export to Excel</a>
									...
									<table width="100%" border="1">
										...
										//get rows query
										$query = mysqli_query($con, "SELECT * FROM reg3 ORDER BY sno DESC");
										...
										<tr>
											...
											<td><?php echo ucfirst($row["pro"]); ?></td>
											<td><?php echo ucfirst($row["pno"]); ?></td>
											<td><?php echo ucfirst($row["institute_name"]); ?></td>
											<td><?php echo ucfirst($row["add1"]); ?></td>
											<td><?php echo ucfirst($row["add2"]); ?></td>
										</tr>
										<?php $sno++;
											}
										} ?>
