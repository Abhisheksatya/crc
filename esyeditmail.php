      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="New Admin.html">New Admin Register</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="Search Student.html">
...
$jprofile = filter_input(INPUT_POST, 'jprofile');
$cname = filter_input(INPUT_POST, 'cname');
$package = filter_input(INPUT_POST, 'package');
$experience = filter_input(INPUT_POST, 'experience');

$myfile = fopen("subject1.txt", "w") or die("Unable to open file!");
fwrite($myfile, $subject);
fclose($myfile);

$myfile = fopen("criteria.txt", "w") or die("Unable to open file!");
fwrite($myfile, $criteria);
fclose($myfile);

$myfile = fopen("jprofile.txt", "w") or die("Unable to open file!");
fwrite($myfile, $jprofile);
fclose($myfile);

$myfile = fopen("cname.txt", "w") or die("Unable to open file!");
fwrite($myfile, $cname);
fclose($myfile);

$myfile = fopen("package.txt", "w") or die("Unable to open file!");
fwrite($myfile, $package);
fclose($myfile);

$myfile = fopen("experience.txt", "w") or die("Unable to open file!");
fwrite($myfile, $experience);
fclose($myfile);
...
<center> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3 style="color:Red">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mail Setup Successful Ready For Mailing !!!
</h3></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br><br><br><br><br><br><br><br><br><br><br><br>
<center> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mail1.php" class="btn btn-primary"><button>Mailing</button></a></center>
</div>
</div>
